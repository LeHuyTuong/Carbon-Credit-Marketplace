        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-7 mb-5 mb-lg-0">
            ...
            <p className="lead text-body-secondary mb-4">
              Connecting EV owners and businesses — turning emission reductions
              into verified, tradable assets.
            </p>

            <div className="d-flex gap-3">
              {/*chỉ hiện khi chua login */}
              {!isAuthenticated && (
                <a href="/register" className="btn btn-brand btn-lg">
                  Sign up now
                </a>
              )}
            ...
            {/*badge benefits*/}
            <ul
              className="list-unstyled d-flex gap-4 flex-wrap small text-muted mt-4 mb-0"
